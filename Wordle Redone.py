...
try: target_file_handle = open(target_file_name)
except: print('Target word file cannot be found')
...
try: valid_file_handle = open(valid_file_name)

except: print('Valid word file cannot be found')
...
# check if word is invalid, and if so display message to user
    if guess_word not in valid_words_list:
        ...
        # JR Remove this unused line of code
...
#create mark that is displayed to user
